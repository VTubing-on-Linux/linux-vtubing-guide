...
load_webview2()
{
    ...
    w_try_cabextract -d "${W_TMP}"/webview2 "${W_CACHE}"/webview2/Microsoft.WebView2.FixedVersionRuntime.143.0.3650.139.x64.cab
    w_try_mkdir "${W_DRIVE_C}/webview2"
    w_try cp -fR "${W_TMP}"/webview2/*/. "${W_DRIVE_C}/webview2"
    w_try chmod u+w -R "${W_DRIVE_C}/webview2"
