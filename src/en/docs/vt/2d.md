...
::: warning
Apple devices over USB do not work by default. You might want to install [iproxy2vts](https://github.com/VTubing-on-Linux/iproxy2vts) to enable this functionality. This software is a proof-of-concept and 100% will contain bugs. Gnome DE is not supported at this time.
:::
